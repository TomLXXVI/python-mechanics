...
Want to know what this library can do and how to use it? Then please check out 
the tutorial Jupyter Notebooks and Python scripts in the *docs/examples* folder.
