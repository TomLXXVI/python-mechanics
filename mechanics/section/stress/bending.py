...
from mechanics.section.geometry import Shape, Polygon, Circle, Annulus, HollowPolygon
from mechanics.utils import AxesRotation2D, Line
...
class Bending:
    """
    Determination of maximum normal stress in a cross-section due to
    bending.
    """
    def __init__(
        self,
        ...
        ----------
        M:
            Components of resultant internal bending moment at cross-section.
